...
```mermaid
flowchart LR
    A["Sugar water<br/>2L + 120-160g"] --> B["F1 ferment<br/>24-48 h"]
    B --> C{"Strain<br/>grains"}
    C -->|grains| D["Fresh sugar<br/>water, reuse"]
    C -->|liquid| E{"Infuse?"}
    E -->|no| G["F2 bottle<br/>12-24 h"]
    E -->|yes| F["X1 infusion<br/>8-12 h"]
    F --> F2["Strain<br/>solids"]
    F2 --> G
    G --> H["Refrigerate"]
    H --> I["Back sweeten<br/>to taste"]
```
